...
import "../../../style/services/NATS-body.css";
...
function NATSbody(){
    ...
    return(
        <section className="permanent-section">
            <h2>National Apprenticeship Training Scheme (NATS)</h2>
            <div className="permanent-body">
                ...
                <div className="body-right animate-2 fade-right-2 " id="NATS"></div>
            </div>
        </section>
    );
}
export default NATSbody;