...
import "../../../style/services/manpower-body.css";
    ...
    return(
        <section className="permanent-section">
            ...
            <div className="permanent-body">
                ...
                <div className="body-right animate-2 fade-right-2 " id='manpower'></div>
            </div>
        </section>
    );
}
export default Manpowerbody;