...
import "../../../style/services/NAPS-body.css";
...
function NAPSbody(){
    ...
    return(
        <section className="permanent-section">
            <h2>National Apprenticeship Promotion Scheme (NAPS)</h2>
            <div className="permanent-body">
                ...
                <div className="body-right animate-2 fade-right-2 " id="NAPS"></div>
            </div>
        </section>
    );
}
export default NAPSbody;